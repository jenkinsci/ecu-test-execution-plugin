...
| **ttProvideUnitReports**      | **unstableThreshold**: Double - Defines a percentage of failed tests to mark the pipeline as unstable <br/><br/> **failedThreshold**: Double - Defines a percentage of failed tests to mark the pipeline as failed <br/><br/> **publishConfig**: [PublishConfig](#publishconfig) - Contains settings to adjust how reports will be provided <br/><br/> **reportIds**: List\<String> - reportIds to upload, ignore to upload all. <br/><br/> **reportGlob**: String - Defines the glob pattern to match the jUnit reports in the test report folder.                                                                                                                                                                                                                                                                                | /                                            |
