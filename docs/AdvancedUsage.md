...
| **ttProvideGeneratedReports** | **selectedReportTypes**: String - Comma seperated names of generated report folders that should be included. <br/><br/> **publishConfig**: [PublishConfig](#publishconfig) - Contains settings to adjust how reports will be provided                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | /                                            |
...
| **failOnError** : boolean  | true          | If true, the build will be marked as failed if an error occurs during publishing.                             |
