...
| **ttProvideGeneratedReports** | **includePattern**: String - ANT pattern to set what generated report folder should be included. <br/><br/> **publishConfig**: [PublishConfig](#publishconfig) - Contains settings to adjust how reports will be provided                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | /                                            |
