...
| **ttProvideGeneratedReports** | **selectedReportTypes**: List<String> - Generated report folders that should be included. <br/><br/> **publishConfig**: [PublishConfig](#publishconfig) - Contains settings to adjust how reports will be provided                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | /                                            |
