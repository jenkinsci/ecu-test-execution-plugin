...
class ContainerTest extends Specification {
    ...
    protected static final String ET_V1_IMAGE_NAME = System.getenv('REGISTRY_GITLAB') + "/hausintern/productdemos/docker/docker-base-images/ecu-test/linux:" + System.getenv('ET_V1_VERSION') // TODO remove once V1 obsolete
